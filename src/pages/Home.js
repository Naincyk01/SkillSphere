...
const Home = () => {
  ...
  return (
    <div className="flex h-full w-full flex-col justify-center px-[5rem]">
      <div className="h-[85px] w-full flex justify-between items-center max-sm:flex max-sm:flex-col max-sm:mb-4">
        <div className="text-xl font-semibold max-sm:flex max-sm:justify-start">All Courses</div>
